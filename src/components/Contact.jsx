...
const Contact = () => {
  return (
    <>
      <div className=" lg:h-[80vh] h-auto pt-16 px-8 lg:mb-0 mb-6 flex lg:flex-row lg:gap-0 gap-6 flex-col-reverse items-center justify-center ">
        {/* map */}
        <div className=" flex justify-center  lg:w-1/2 w-[90%] h-auto   mt-4 mb-4 overflow-hidden rounded-xl">
          <iframe
            ...
            className=" border border-blue-500 rounded-xl h-[450px]"
          />
        </div>
        {/* form */}
