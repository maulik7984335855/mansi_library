    ...
    <>
        ...
        <div className="container  max-w-screen-2xl  flex flex-col items-center justify-center mx-auto gap-10 text-white  pt-5 bg-blue-500 rounded-b-3xl lg:h-screen  ">
          ...
          <div className="flex gap-4 pb-40 ">
            <motion.button
              ...
              className="bg-white cursor-pointer text-black w-[140px] px-2 py-3 rounded-lg hover:shadow-2xl "
            >
              Download Now
            </motion.button>
            <motion.button
              animate={{x:[0,100,0]}}
              onClick={clickNavigate}
              className="bg-transparent border flex-1 cursor-pointer border-white w-[140px] px-2 py-3 rounded-lg hover:shadow-2xl "
            >
              Read Free Book
            </motion.button>
          </div>
      ...
      <div className="bg-pink-200 pt-5 rounded-3xl flex gap-8 items-center justify-center flex-col ">
        <div className="flex justify-center lg:flex-row flex-col items-center gap-10">
          <h2 className="lg:w-1/3  text-4xl font-medium">
            About
            <br /> The Mansi Libary
          </h2>
          <p className="lg:w-1/3 lg:text-left text-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit dicta
            numquam possimus provident? Est minus tenetur consequuntur sequi
            tempora vitae temporibus
          </p>
        </div>
